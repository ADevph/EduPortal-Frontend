...
<div className="bg-cyan-800  navbar text-white">
  ...
  <img src="/portal.png" alt="Logo" class="h-24 w-48 mr-2"></img>
    <Link href="/" className=" normal-case text-3xl  ">Edu<span className=" text-cyan-300 text-4xl ">Portal</span></Link> 
  </div>
  ...
  <div class="navbar-center hidden lg:flex">
    ...
    <li className="hover:bg-blue-300 rounded-lg"> <Link href="announcement"> Announcements </Link></li>
      ...
      <li tabindex="0">
        <details  className=" rounded-lg">
          ...
          <ul class="bg-cyan-600 text-black hover:bg-blue-200 rounded-lg ">
            <li> <Link href="notices"> Scholarship </Link></li>
  ...
  <ul className="menu menu-horizontal px-1 text-2xl">
      ...
      <li className="hover:bg-blue-400 rounded-lg"> <Link className="" href="regform" > Sign Up </Link></li>
