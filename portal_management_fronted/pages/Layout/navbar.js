...
export default function NavBar() {
  ...
  async function fetchData() {
    ...
    try {
      const response = await axios.get(process.env.NEXT_PUBLIC_API_ENDPOINT + "/student/getuser/" + user.email,
...
{jsonData &&
    <div className="navbar bg-[#F5F5F5]">
      ...
      {/* <Link href="/" className=" normal-case text-4xl  ">EduPortal</Link>  */}
        ...
        <a className="btn btn-ghost normal-case text-xl" href="/">EduPortal</a>
      </div>
